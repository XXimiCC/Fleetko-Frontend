<template>
  <div class="container">
    <div class="terms col-md-8 ml-auto mr-auto">
      <div class="terms__main-title">
        <h2 class="h2-secondary">Terms of Service</h2>
        <div class="terms__modified">
          <span class="label">Last modified:</span>
          <span class="value">June 26, 2018</span>
        </div>
      </div>
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">OVERVIEW</h3>

        <p class="paragraph-secondary terms__paragraph">
          This website is operated by Fleetzone Inc. Throughout the site, the
          terms “we”, “us” and “our” refer to Fleetzone Inc. Fleetzone Inc
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">ONLINE STORE TERMS</h3>
        <p class="paragraph-secondary terms__paragraph">
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">GENERAL CONDITIONS</h3>
        <p class="paragraph-secondary terms__paragraph">
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">
      ...
      <div class="terms__block">
        ...
        <p class="paragraph-secondary terms__paragraph">
          We attempt to be as accurate as possible in regards to product
          descriptions, labels and various other informational content found
          throughout the Site. However, we cannot guarantee that product
          descriptions or other content on the Site is accurate complete,
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">OPTIONAL TOOLS</h3>
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">THIRD-PARTY LINKS</h3>
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">PERSONAL INFORMATION</h3>

        <p class="paragraph-secondary terms__paragraph">
          Your submission of personal information through the store is governed
          by our
          <router-link :to="{ name: 'privacyPolicy' }" class="link-quaternary"
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">PROHIBITED USES</h3>
      ...
      <div class="terms__block">
        ...
        <p class="paragraph-secondary terms__paragraph">
          In no case shall Fleetzone Inc, our directors, officers, employees,
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">INDEMNIFICATION</h3>

        <p class="paragraph-secondary terms__paragraph">
          You agree to indemnify, defend and hold harmless Fleetzone Inc and our
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">SEVERABILITY</h3>
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">TERMINATION</h3>
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">ENTIRE AGREEMENT</h3>
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">GOVERNING LAW</h3>

        <p class="paragraph-secondary terms__paragraph">
          These Terms of Service and any separate agreements whereby we provide
          you Services shall be governed by and construed in accordance with the
          laws of 701 South Gifford Avenue #109, San Bernardino, CA, 92408,
          United States.
        </p>
      </div>

      <div class="terms__block">
        <h3 class="h3-secondary terms__title">CHANGES TO TERMS OF SERVICE</h3>
      ...
      <div class="terms__block">
        <h3 class="h3-secondary terms__title">CONTACT INFORMATION</h3>

        <p class="paragraph-secondary terms__paragraph">
          Questions about the Terms of Service should be sent to us at
          <a href="mailto:sales@fleetzoneinc.com">sales@fleetzoneinc.com</a>.
        </p>
      </div>
    </div>
  </div>
